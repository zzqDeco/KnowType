...
- `InputCommitApplicationRuntime` owns commit-result plan mapping,
  ...
  construction, and lifecycle finish plans. It returns values only; the
  coordinator remains the order-sensitive side-effect owner.
