...
- toggles `AI Continuation` by writing `InputMethodRuntimePreferences` and forcing the coordinator to reload runtime preferences for the external menu change
