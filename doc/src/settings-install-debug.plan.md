...
- request selection of `com.knowtype.inputmethod.KnowType.Mode` while directing developers to `scripts/diagnose-inputmethod.sh` for the independent system status check;
