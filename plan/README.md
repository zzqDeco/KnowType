...
|---|---|---|
| [release-0.2.12.plan.md](release-0.2.12.plan.md) | Prepare and publish the KnowType v0.2.12 Developer Preview release | Active |
...
| [context-digest-cumulative-budget.plan.md](context-digest-cumulative-budget.plan.md) | Enforce persistent 6-hour and rolling daily digest budgets while honoring long 429 recovery hints | Active |
...
| [release-0.2.11.plan.md](release-0.2.11.plan.md) | Prepare and publish the KnowType v0.2.11 Developer Preview release | Delivered |
