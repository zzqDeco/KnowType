...
| [input-commit-application-runtime-refactor.plan.md](input-commit-application-runtime-refactor.plan.md) | Extract commit-result planning, side-effect context construction, and lifecycle finish planning from the coordinator | Active |
