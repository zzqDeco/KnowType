...
- Install preflight rejects parent-only bundles that do not declare a menu-visible input mode, including `--from-bundle`, `--from-release-zip`, and DMG payload sources.
