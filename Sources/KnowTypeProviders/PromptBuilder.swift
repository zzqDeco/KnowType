...
enum PromptBuilder {
    ...
    For correction, return likely prefixes only. Support short pinyin-initial abbreviations such as wsm -> 为什么. Preserve technical tokens such as API, JSON, FastAPI, iOS, macOS, InputMethodKit, snake_case, camelCase, and userID.
