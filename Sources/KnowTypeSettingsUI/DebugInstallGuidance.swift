...
enum DebugInstallGuidance {
    ...
    static let commands: [String] = [
        ...
        "./scripts/package-dmg.sh --version 0.2.1 --build 1",
        "./scripts/install-inputmethod.sh --from-dmg-payload /Volumes/KnowType*/",
        "./scripts/install-inputmethod.sh --from-release-zip dist/release/KnowType-v0.2.1-macos-local-mvp.zip",
        "./scripts/diagnose-inputmethod.sh --strict",
        "./scripts/diagnose-inputmethod.sh --json",
